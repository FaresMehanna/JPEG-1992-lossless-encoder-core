...
module top(\pixel_in$1 , \pixel_in$2 , \pixel_in$3 , valid_in, latch_output, rst, clk, enc_out, enc_out_ctr, nready, valid_out, pixel_in);
  ...
  (* src = "./migen_src/integration_2.py:31" *)
  output valid_out;
  assign \$9  = lj92_pipeline_fifo_close_full == (* src = "./migen_src/integration_2.py:57" *) 1'h0;
  assign \$11  = \$7  & (* src = "./migen_src/integration_2.py:57" *) \$9 ;
  ...
  assign \$7  = valid_in == (* src = "./migen_src/integration_2.py:57" *) 1'h1;
  converter converter (
    .clk(clk),
