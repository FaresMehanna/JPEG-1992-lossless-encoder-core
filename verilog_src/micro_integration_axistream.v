...
(* generator = "nMigen" *)
module core_axi_lite(s_axi_ri__arvalid, s_axi_wi__awvalid, s_axi_ri__araddr, s_axi_ri__rready, s_axi_wi__awaddr, s_axi_wi__wvalid, s_axi_wi__wdata, s_axi_wi__wstrb, s_axi_wi__bready, full_rst, rst, full_clk, clk, rp_addr, wp_addr, wp_data, wp_en, allowed_cycles, height, width, s_axi_ro__arready, s_axi_ro__rvalid, s_axi_wo__awready, s_axi_wo__wready, s_axi_wo__bvalid, s_axi_ro__rdata, s_axi_ro__rresp, s_axi_wo__bresp, rp_data);
  wire [63:0] \$1 ;
  wire \$100 ;
  wire \$102 ;
  wire \$104 ;
...
(* generator = "nMigen" *)
module integration_1(pixel_in, rst, clk, s_axi_ri__arvalid, s_axi_wi__awvalid, s_axi_ri__araddr, s_axi_ri__rready, s_axi_wi__awaddr, s_axi_wi__wvalid, s_axi_wi__wdata, s_axi_wi__wstrb, s_axi_wi__bready, full_rst, full_clk, enc_out, enc_out_ctr, valid_out, end_out, end_of_frame, fend_out, s_axi_ro__arready, s_axi_ro__rvalid, s_axi_wo__awready, s_axi_wo__wready, s_axi_wo__bvalid, s_axi_ro__rdata, s_axi_ro__rresp, s_axi_wo__bresp, valid_in);
  (* src = "core_axi_lite.py:101" *)
...
(* generator = "nMigen" *)
module integration_2(pixel_in, latch_output, rst, clk, s_axi_ri__arvalid, s_axi_wi__awvalid, s_axi_ri__araddr, s_axi_ri__rready, s_axi_wi__awaddr, s_axi_wi__wvalid, s_axi_wi__wdata, s_axi_wi__wstrb, s_axi_wi__bready, full_rst, full_clk, nready, enc_out, enc_out_ctr, valid_out, out_end, fend_out, s_axi_ro__arready, s_axi_ro__rvalid, s_axi_wo__awready, s_axi_wo__wready, s_axi_wo__bvalid, s_axi_ro__rdata, s_axi_ro__rresp, s_axi_wo__bresp, valid_in);
  wire \$1 ;
  wire \$11 ;
  wire \$13 ;
  wire \$15 ;
...
(* generator = "nMigen" *)
module integration_3(valid_in, busy_in, rst, clk, s_axi_ri__arvalid, s_axi_wi__awvalid, s_axi_ri__araddr, s_axi_ri__rready, s_axi_wi__awaddr, s_axi_wi__wvalid, s_axi_wi__wdata, s_axi_wi__wstrb, s_axi_wi__bready, full_rst, full_clk, data_out, valid_out, nready, fend_out, s_axi_ro__arready, s_axi_ro__rvalid, s_axi_wo__awready, s_axi_wo__wready, s_axi_wo__bvalid, s_axi_ro__rdata, s_axi_ro__rresp, s_axi_wo__bresp, pixel_in);
...
(* top =  1  *)
(* generator = "nMigen" *)
module top(s_tdata, s_tlast, s_tvalid, full_clk, full_rst, s_axi_ri__arvalid, s_axi_wi__awvalid, s_axi_ri__araddr, s_axi_ri__rready, s_axi_wi__awaddr, s_axi_wi__wvalid, s_axi_wi__wdata, s_axi_wi__wstrb, s_axi_wi__bready, end_in, \end_in$1 , m_tvalid, m_tlast, m_tdata, s_tready, s_axi_ro__arready, s_axi_ro__rdata, s_axi_ro__rresp, s_axi_ro__rvalid, s_axi_wo__awready, s_axi_wo__wready, s_axi_wo__bresp, s_axi_wo__bvalid, m_tready);
  wire \$2 ;
  wire \$4 ;
  (* src = "micro_integration_axistream.py:15" *)
  reg [15:0] \$next\m_tdata ;
  (* src = "micro_integration_axistream.py:13" *)
  reg \$next\m_tlast ;
  (* src = "micro_integration_axistream.py:12" *)
  reg \$next\m_tvalid ;
  (* src = "micro_integration_axistream.py:39" *)
  reg \$next\s_end ;
  (* src = "micro_integration_axistream.py:20" *)
  reg \$next\s_tready ;
  ...
  (* src = "micro_integration_axistream.py:13" *)
  output m_tlast;
  (* src = "micro_integration_axistream.py:14" *)
  input m_tready;
  (* src = "micro_integration_axistream.py:12" *)
  output m_tvalid;
  (* src = "nmigen/hdl/rec.py:84" *)
  ...
  (* src = "micro_integration_axistream.py:39" *)
  wire s_end;
  (* src = "micro_integration_axistream.py:21" *)
  input [31:0] s_tdata;
  (* src = "micro_integration_axistream.py:19" *)
  input s_tlast;
  (* src = "micro_integration_axistream.py:20" *)
  output s_tready;
  (* src = "micro_integration_axistream.py:18" *)
  input s_tvalid;
  (* src = "micro_integration.py:42" *)
  ...
  assign \$2  = m_tready == (* src = "micro_integration_axistream.py:45" *) 1'h0;
  assign \$4  = top_module_nready == (* src = "micro_integration_axistream.py:52" *) 1'h0;
...
(* generator = "nMigen" *)
module top_module(full_rst, busy_in, pixel_in, valid_in, s_axi_ri__arvalid, s_axi_wi__awvalid, s_axi_ri__araddr, s_axi_ri__rready, s_axi_wi__awaddr, s_axi_wi__wvalid, s_axi_wi__wdata, s_axi_wi__wstrb, s_axi_wi__bready, end_in, \end_in$1 , data_out, valid_out, end_out, nready, s_axi_ro__arready, s_axi_ro__rvalid, s_axi_wo__awready, s_axi_wo__wready, s_axi_wo__bvalid, s_axi_ro__rdata, s_axi_ro__rresp, s_axi_wo__bresp, full_clk);
  wire \$2 ;
  wire \$4 ;
  wire \$6 ;
  wire \$8 ;
